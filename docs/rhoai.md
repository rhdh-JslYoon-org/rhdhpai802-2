...
2) Go to the `Data Science Projects` section and access your application's project named `rhdhpai802-2`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `rhehpai802-2-notebook`.
...
5) In the terminal, run `cd rhehpai802-2` to navigate to your sample app's directory.
